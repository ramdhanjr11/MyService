...
class MainActivity : AppCompatActivity() {
    ...
    private val mServiceConnection = object : ServiceConnection {
        ...
        /**
         * Kode ini merupakan sebuah listener untuk menerima callback dari ServiceConnection
         */
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnStartBoundService.setOnClickListener {
             ...
             * mServiceConnection = sebuah ServiceConnection berfungsi sebagai callback dari kelas MyBoundService.
             * BIND_AUTO_CREATE =  Membuat sebuah service jika service tersebut belum aktif.
             */
        }
